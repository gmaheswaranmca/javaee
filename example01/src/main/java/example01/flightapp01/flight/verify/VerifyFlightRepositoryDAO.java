package example01.flightapp01.flight.verify;
...
import example01.flightapp01.flight.FlightIRepository;
import example01.flightapp01.flight.FlightRepositoryDAO;

public class VerifyFlightRepositoryDAO {
	static FlightIRepository repository = new FlightRepositoryDAO(); 
